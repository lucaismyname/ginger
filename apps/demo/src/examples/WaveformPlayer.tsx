...
function LiveWaveform() {
  ...
  return (
    <div className="rounded-2xl border border-orange-200 bg-orange-50/70 p-5 shadow-sm ring-1 ring-orange-100">
      ...
      <div className="mt-4 rounded-xl border border-orange-200 bg-gradient-to-b from-white to-orange-100/40 p-3">
      ...
      <div className="mt-4 space-y-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Ginger.Control.PlaybackRate className="rounded-lg border border-orange-300 bg-white px-2 py-1 text-xs text-orange-900" />
        </div>
      </div>
    </div>
  );
