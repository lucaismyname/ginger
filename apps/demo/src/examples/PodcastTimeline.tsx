      ...
      <div className="rounded-2xl border border-orange-200 bg-white p-6 shadow-sm">
        <div className="flex items-start gap-4">
          ...
          <div className="min-w-0 flex-1">
            <div className="truncate text-xs font-semibold uppercase tracking-wide text-orange-500">
          ...
          <Ginger.Control.PlaybackRate className="rounded-lg border border-orange-200 bg-orange-50 px-2 py-1 text-sm text-orange-700" />
        </div>

        <div className="mt-5 grid gap-2">
          <Ginger.Control.SeekBar className="accent-orange-600" />
        ...
        <div className="mt-5 flex flex-wrap items-center gap-2">
          ...
          <Ginger.Control.PlayPause className="rounded-lg bg-orange-600 px-4 py-2 text-sm font-semibold text-white hover:bg-orange-700" />
